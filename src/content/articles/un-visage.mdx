...
references:
  - image: src/content/assets/articles/un-visage/references/0/image.jpg
    title: >-
      Détail d'un vitrail de la cathédrale de Bourges. Adoration du veau d'or,
      Exode du peuple hébreu depuis l’Égypte
    author: Auteur inconnu, environ 1220
  - image: src/content/assets/articles/un-visage/references/1/image.jpg
    title: Interior II
    author: Richard Hamilton, 1964
  - image: src/content/assets/articles/un-visage/references/2/image.jpg
    title: 'La Femme qui pleure '
    author: Pablo Picasso, 1937, Huile sur toile, 59,5 × 49 cm
---
## 🤔 Que faut-il faire?
...
<Eval rows={[{description:"J’ai été investi(e) et responsable ( envers mes camarades, le matériel, etc.)"},{description:"J’ai d’abord posé mes questions à mes camarades avant de les poser au professeur\n"},{description:"J’ai été calme durant toute la séquence"}]} />

...
category: 3eme
thumbnail:
  image: src/content/assets/articles/un-objet-du-futur/thumbnail/image.webp
  alt: '""'
references:
  - image: src/content/assets/articles/un-objet-du-futur/references/0/image.webp
    title: Inventions- Carnet de recherches
    author: Léonard de Vinci 1452-1519
  - image: src/content/assets/articles/un-objet-du-futur/references/1/image.webp
    title: Croquis d'invention
    author: Léonard de Vinci
  - image: src/content/assets/articles/un-objet-du-futur/references/2/image.webp
    title: Croquis d'inventions
    author: Léonard de Vinci
  - image: src/content/assets/articles/un-objet-du-futur/references/3/image.webp
    title: Reconstitution du chevalier mécanique
    author: D'après une invention de Léonard de Vinci
  - image: src/content/assets/articles/un-objet-du-futur/references/4/image.webp
    title: Chindogu
    author: Kenji Kawakami
    other: Série d'objets réalisés à partir des années 80, au Japon
  - image: src/content/assets/articles/un-objet-du-futur/references/5/image.webp
    title: Chindogu
    author: Kenji Kawakami
  - image: src/content/assets/articles/un-objet-du-futur/references/6/image.webp
    title: Chindogu
    author: Kenji Kawakami
  - image: src/content/assets/articles/un-objet-du-futur/references/7/image.webp
    title: Photogramme du film Minority Report
    author: Steven Spielberg, 2002
  - image: src/content/assets/articles/un-objet-du-futur/references/8/image.webp
...
<Eval rows={[{description:"J’ai été attentif·ve et investi·e durant toute la séquence et cela se voit à travers mon travail."},{description:"Mon objet est novateur, c'est à dire qu'il n'existe pas aujourd'hui."},{description:"Le mode d’emploi est clair et bien lisible, c’est un objet qui donne envie d’être consulté."},{description:"Bonus: Mon travail est solidement assemblé."}]} />

...
<Eval rows={["J’ai été attentif·ve et investi·e durant toute la séquence et cela se voit à travers mon travail.","Mon objet est novateur, c'est à dire qu'il n'existe pas aujourd'hui.","Le mode d’emploi est clair et bien lisible, c’est un objet qui donne envie d’être consulté.","Bonus: Mon travail est solidement assemblé."]} />
